...
export const portfolioZones = [
  ...
  },
  {
    ...
    sectionLabel: "EES",
    description:
      "The connected Enterprise Execution Suite gateway linking global supply planning with pharmaceutical manufacturing execution, automation, compliance, analytics, and digital twins.",
    ...
    records: [
      ...
      "Production order and material-readiness handoff",
      "EES Pharma Process Twin — Part 2",
      "Connected planning-to-execution digital thread"
    ],
    components: [
